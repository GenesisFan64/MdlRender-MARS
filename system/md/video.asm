...
; 
; 32X: RV bit must be set before starting DMA
; --------------------------------------------------------
...
.rvstart:
	...
	; SOURCE
		move.l	d0,d4
	if MCD
		cmp.l	#syscd_wordram,d4		; below WRAM
		blt.s	.exclude
		cmp.l	#syscd_wordram+$3FFFF,d4	; over WRAM
		bge.s	.exclude
		add.l	#2,d4
.exclude:
	endif
...
; 	if MCD
; 		swap	d4			; MCD: failsafe
; 		move.w	d5,d4
; 		and.w	#$FF7F,d4		; Clear DMA bit
; 		move.l	a5,-(sp)		; Save a5 if needed
; 		movea.l	d0,a5
; 		move.l	d4,(a4)
; 		move.l	(a5),-(a4)
; 		move.l	(sp)+,a5
