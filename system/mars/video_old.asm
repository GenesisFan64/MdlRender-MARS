...
MAX_POLYGONS	equ	544
MAX_MODELS	equ	16
MAX_ZDISTANCE	equ	-192
...
dda_left:
		...
		add 	r8,r3
		mov 	@r3,r4			; r4 - OLD X point
		mov 	r4,r0
		shll16	r0
		mov 	r0,@(plydda_x,r14)
		mov 	@(4,r3),r5		; r5 - OLD Y point
		
	; SRC OLD POINTS
		mov 	r1,r3
		add 	#polygn_srcpnts,r3
		add 	r8,r3
		mov 	@r3,r6			; r6 - OLD SRC X point
		mov 	r6,r0
		shll16	r0
		mov 	r0,@(plydda_src_x,r14)
		mov 	@(4,r3),r7		; r7 - OLD SRC Y point
		mov 	r7,r0
		shll16	r0
...
.exitmdl:
	...
	; Sort faces
	; Z pos | Polygon address
		mov	#MARSMdl_ZList,r14	; Z list
		mov	#MARSMdl_ZList+4,r13	; Z list	
...
.waitdx:
	...
	; mach - face counter
		...
		mov	#MARSMdl_ZList,r9	; Zbuffer (Zdata)
		mov	#MAX_POLYGONS,r0
		cmp/ge	r0,r10
		bf	.plgnloop
		mov	r0,r10
