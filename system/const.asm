...
RAM_ExRamSub	ds.w $500			; MCD Jump System or 32X ROM to VDP DMA Transfer
sizeof_mdram	ds.l 0
	endif
...
RAM_SysFlags	ds.w 1			; (byte)
	if MCD=0
RAM_MdMarsVInt	ds.w 3			; MD/MARS ONLY: JMP xxxx xxxx
RAM_MdMarsHint	ds.w 3			; MD/MARS ONLY: JMP xxxx xxxx
	endif
sizeof_mdsys	ds.l 0
		finish
